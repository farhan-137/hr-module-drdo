...
<div class="page title-page">
  ...
  <div class="sign-grid">
    <div class="sign-box">
      ...
      <div><strong>Internship Trainee</strong></div>
      <div>B.Tech, Computer Science / ECE</div>
      <div>(Technical Institution)</div>
    </div>
...
<div class="page">
  ...
  <p>First and foremost, I would like to express my sincere gratitude to the Training and Placement Division for giving me the opportunity to undertake my technical internship at <strong>Solid State Physics Laboratory (SSPL) -- DRDO</strong>. I am deeply grateful to the Director and Senior Scientists at SSPL for considering me for the internship in this esteemed national research laboratory.</p>

  <p>I perceive this opportunity as a significant milestone in the development of my engineering career and will strive to use the gained knowledge, technical exposure, and system architecture methodologies in the best possible way. I am thankful to SSPL for providing an advanced platform to learn, design, and implement mission-critical enterprise systems.</p>

  <p>I would like to express my deepest appreciation to my <strong>Project Guide</strong> and the <strong>Scientist Mentors</strong> of the HR and Software Engineering Divisions for their continuous guidance, invaluable teachings, constructive architectural reviews, and continuous mentorship during the design, coding, security hardening, and deployment phases of the Trainee &amp; Internship Management Portal (TIMP).</p>
  ...
  <div style="margin-top: 100px; font-size: 10.5pt; line-height: 1.4;">
    <div><strong>Date:</strong> 31st July, 2026</div>
    <div><strong>Place:</strong> Delhi</div>
    <div style="margin-top: 10px;"><strong>Name:</strong> Internship Trainee</div>
    <div><strong>Mobile No.:</strong> +91 9876543210</div>
    <div><strong>Email:</strong> trainee@sspl.drdo.in</div>
  </div>
</div>
...
<div class="page">
  ...
  <p>The codebase and technical documentation presented herein have been authored independently and have not been submitted elsewhere for any academic degree, diploma, or institutional award.</p>

  <div style="display: flex; justify-content: space-between; margin-top: 200px; font-size: 10.5pt; line-height: 1.4;">
    <div style="width: 45%;">
...
<div class="page">
  ...
  <p>The project titled <strong>“Trainee &amp; Internship Management Portal (TIMP)”</strong> was conceptualized and executed during the internship tenure at SSPL -- DRDO. The objective was to replace conventional, time-consuming paper-based workflows with a secure, performant, and role-based web management platform tailored to the operational requirements of the HR and Systems Divisions.</p>
...
<div class="page">
  <h1 class="chapter-title">CHAPTER 2: SYSTEM ARCHITECTURE &amp; DESIGN</h1>
  ...
  <div class="diagram-box">
    <svg viewBox="0 0 650 180" class="diagram-svg">
      <rect x="20" y="30" width="160" height="110" rx="8" fill="#eef2ff" stroke="#4f46e5" stroke-width="2"/>
      <text x="100" y="60" font-family="Times New Roman" font-size="13" font-weight="bold" text-anchor="middle" fill="#1e1b4b">React 18 Frontend</text>
      <text x="100" y="82" font-family="Times New Roman" font-size="10" text-anchor="middle" fill="#4338ca">TypeScript + Vite</text>
      <text x="100" y="100" font-family="Times New Roman" font-size="10" text-anchor="middle" fill="#4338ca">Tailwind CSS (Stripe UI)</text>
      <text x="100" y="120" font-family="Times New Roman" font-size="9" text-anchor="middle" fill="#6366f1">Axios Client + JWT</text>

      <path d="M 180 85 L 240 85" stroke="#4f46e5" stroke-width="2"/>
      <path d="M 240 75 L 180 75" stroke="#4f46e5" stroke-width="2"/>
      <text x="210" y="70" font-family="Times New Roman" font-size="9" font-weight="bold" text-anchor="middle" fill="#333">HTTPS / REST</text>
      <text x="210" y="105" font-family="Times New Roman" font-size="8" text-anchor="middle" fill="#666">JSON Payloads</text>

      <rect x="245" y="30" width="170" height="110" rx="8" fill="#f0fdf4" stroke="#16a34a" stroke-width="2"/>
      <text x="330" y="60" font-family="Times New Roman" font-size="13" font-weight="bold" text-anchor="middle" fill="#14532d">ASP.NET Core Web API</text>
      <text x="330" y="82" font-family="Times New Roman" font-size="10" text-anchor="middle" fill="#15803d">C# REST Controllers</text>
      <text x="330" y="100" font-family="Times New Roman" font-size="10" text-anchor="middle" fill="#15803d">JWT &amp; BCrypt Security</text>
      <text x="330" y="120" font-family="Times New Roman" font-size="9" text-anchor="middle" fill="#22c55e">CORS &amp; Middleware</text>

      <path d="M 415 85 L 475 85" stroke="#16a34a" stroke-width="2"/>
      <path d="M 475 75 L 415 75" stroke="#16a34a" stroke-width="2"/>
      <text x="445" y="70" font-family="Times New Roman" font-size="9" font-weight="bold" text-anchor="middle" fill="#333">EF Core</text>
      <text x="445" y="105" font-family="Times New Roman" font-size="8" text-anchor="middle" fill="#666">LINQ Queries</text>

      <rect x="480" y="30" width="150" height="110" rx="8" fill="#fef2f2" stroke="#dc2626" stroke-width="2"/>
      <text x="555" y="60" font-family="Times New Roman" font-size="13" font-weight="bold" text-anchor="middle" fill="#7f1d1d">Relational Database</text>
      <text x="555" y="82" font-family="Times New Roman" font-size="10" text-anchor="middle" fill="#b91c1c">SQLite (drdo_hr.db)</text>
      <text x="555" y="100" font-family="Times New Roman" font-size="10" text-anchor="middle" fill="#b91c1c">PostgreSQL Compatible</text>
      <text x="555" y="120" font-family="Times New Roman" font-size="9" text-anchor="middle" fill="#ef4444">ACID Transactional</text>
    </svg>
...
<div class="page">
  ...
  <div class="diagram-box">
    <svg viewBox="0 0 600 200" class="diagram-svg">
      <circle cx="300" cy="100" r="55" fill="#f8fafc" stroke="#0f172a" stroke-width="2"/>
      <text x="300" y="95" font-family="Times New Roman" font-size="11" font-weight="bold" text-anchor="middle">0.0</text>
      <text x="300" y="112" font-family="Times New Roman" font-size="11" font-weight="bold" text-anchor="middle">TIMP System</text>

      <rect x="20" y="65" width="110" height="70" rx="4" fill="#f1f5f9" stroke="#334155" stroke-width="1.5"/>
      <text x="75" y="105" font-family="Times New Roman" font-size="11" font-weight="bold" text-anchor="middle">HR Admin</text>
      <path d="M 130 90 L 245 90" stroke="#334155" stroke-width="1.5"/>
      <text x="187" y="82" font-family="Times New Roman" font-size="8" text-anchor="middle">Registration / Allocation</text>
      <path d="M 245 110 L 130 110" stroke="#334155" stroke-width="1.5"/>
      <text x="187" y="125" font-family="Times New Roman" font-size="8" text-anchor="middle">Analytics / Certificates</text>

      <rect x="470" y="65" width="110" height="70" rx="4" fill="#f1f5f9" stroke="#334155" stroke-width="1.5"/>
      <text x="525" y="105" font-family="Times New Roman" font-size="11" font-weight="bold" text-anchor="middle">Scientist Mentor</text>
      <path d="M 470 90 L 355 90" stroke="#334155" stroke-width="1.5"/>
      <text x="412" y="82" font-family="Times New Roman" font-size="8" text-anchor="middle">Roll Call / Pass Approval</text>
      <path d="M 355 110 L 470 110" stroke="#334155" stroke-width="1.5"/>
      <text x="412" y="125" font-family="Times New Roman" font-size="8" text-anchor="middle">Trainee Progress</text>
    </svg>
...
<div class="page">
  <h1 class="chapter-title">CHAPTER 3: BACKEND REST API IMPLEMENTATION</h1>
...
<div class="page">
  <h1 class="chapter-title">CHAPTER 4: FRONTEND UI &amp; COMPONENT ENGINEERING</h1>
...
<div class="page">
  ...
  <div class="diagram-box">
    <svg viewBox="0 0 600 110" class="diagram-svg">
      <rect x="10" y="35" width="100" height="45" rx="4" fill="#eff6ff" stroke="#3b82f6" stroke-width="1.5"/>
      <text x="60" y="62" font-family="Times New Roman" font-size="11" font-weight="bold" text-anchor="middle" fill="#1e3a8a">1. Register (New)</text>

      <path d="M 110 57 L 135 57" stroke="#3b82f6" stroke-width="1.5"/>

      <rect x="135" y="35" width="100" height="45" rx="4" fill="#fef3c7" stroke="#f59e0b" stroke-width="1.5"/>
      <text x="185" y="62" font-family="Times New Roman" font-size="11" font-weight="bold" text-anchor="middle" fill="#78350f">2. Mentor Assigned</text>

      <path d="M 235 57 L 260 57" stroke="#f59e0b" stroke-width="1.5"/>

      <rect x="260" y="35" width="100" height="45" rx="4" fill="#ecfdf5" stroke="#10b981" stroke-width="1.5"/>
      <text x="310" y="62" font-family="Times New Roman" font-size="11" font-weight="bold" text-anchor="middle" fill="#064e3b">3. Active Research</text>

      <path d="M 360 57 L 385 57" stroke="#10b981" stroke-width="1.5"/>

      <rect x="385" y="35" width="100" height="45" rx="4" fill="#f5f3ff" stroke="#8b5cf6" stroke-width="1.5"/>
      <text x="435" y="62" font-family="Times New Roman" font-size="11" font-weight="bold" text-anchor="middle" fill="#4c1d95">4. Roll Call Logged</text>

      <path d="M 485 57 L 510 57" stroke="#8b5cf6" stroke-width="1.5"/>

      <rect x="510" y="35" width="80" height="45" rx="4" fill="#fdf2f8" stroke="#ec4899" stroke-width="1.5"/>
      <text x="550" y="62" font-family="Times New Roman" font-size="11" font-weight="bold" text-anchor="middle" fill="#831843">5. Certificate</text>
    </svg>
...
<div class="page">
  ...
  <div class="diagram-box">
    <svg viewBox="0 0 580 130" class="diagram-svg">
      <text x="20" y="25" font-family="Times New Roman" font-size="11" font-weight="bold" fill="#333">Annual Attendance Heatmap (52-Week View)</text>
      ...
      <g transform="translate(20, 40)">
        ...
        <rect x="45" y="0" width="12" height="12" rx="2" fill="#ef4444"/>
        <rect x="60" y="0" width="12" height="12" rx="2" fill="#10b981"/>
        <rect x="75" y="0" width="12" height="12" rx="2" fill="#10b981"/>
        <rect x="90" y="0" width="12" height="12" rx="2" fill="#f59e0b"/>
        <rect x="105" y="0" width="12" height="12" rx="2" fill="#10b981"/>
        <rect x="120" y="0" width="12" height="12" rx="2" fill="#10b981"/>
        <rect x="135" y="0" width="12" height="12" rx="2" fill="#10b981"/>
        <rect x="150" y="0" width="12" height="12" rx="2" fill="#10b981"/>
        <rect x="165" y="0" width="12" height="12" rx="2" fill="#10b981"/>
        <rect x="180" y="0" width="12" height="12" rx="2" fill="#10b981"/>
        <rect x="195" y="0" width="12" height="12" rx="2" fill="#10b981"/>
        <rect x="210" y="0" width="12" height="12" rx="2" fill="#10b981"/>
        <rect x="225" y="0" width="12" height="12" rx="2" fill="#10b981"/>
        <rect x="240" y="0" width="12" height="12" rx="2" fill="#10b981"/>
        <rect x="255" y="0" width="12" height="12" rx="2" fill="#10b981"/>
        <rect x="270" y="0" width="12" height="12" rx="2" fill="#10b981"/>
        <rect x="285" y="0" width="12" height="12" rx="2" fill="#10b981"/>
        <rect x="300" y="0" width="12" height="12" rx="2" fill="#10b981"/>
        <rect x="315" y="0" width="12" height="12" rx="2" fill="#10b981"/>
        <rect x="330" y="0" width="12" height="12" rx="2" fill="#10b981"/>
        <rect x="345" y="0" width="12" height="12" rx="2" fill="#10b981"/>
        <rect x="360" y="0" width="12" height="12" rx="2" fill="#10b981"/>
        <rect x="375" y="0" width="12" height="12" rx="2" fill="#10b981"/>
        <rect x="390" y="0" width="12" height="12" rx="2" fill="#10b981"/>
        <rect x="405" y="0" width="12" height="12" rx="2" fill="#10b981"/>
        <rect x="420" y="0" width="12" height="12" rx="2" fill="#10b981"/>
        <rect x="435" y="0" width="12" height="12" rx="2" fill="#10b981"/>
        <rect x="450" y="0" width="12" height="12" rx="2" fill="#10b981"/>
        <rect x="465" y="0" width="12" height="12" rx="2" fill="#10b981"/>
        <rect x="480" y="0" width="12" height="12" rx="2" fill="#10b981"/>
        <rect x="495" y="0" width="12" height="12" rx="2" fill="#10b981"/>
        <rect x="510" y="0" width="12" height="12" rx="2" fill="#10b981"/>
        <rect x="525" y="0" width="12" height="12" rx="2" fill="#10b981"/>
      </g>

      <g transform="translate(20, 90)">
        <rect x="0" y="0" width="10" height="10" rx="2" fill="#10b981"/>
        <text x="16" y="9" font-family="Times New Roman" font-size="9" fill="#444">Present</text>

        <rect x="90" y="0" width="10" height="10" rx="2" fill="#ef4444"/>
        <text x="106" y="9" font-family="Times New Roman" font-size="9" fill="#444">Absent</text>

        <rect x="180" y="0" width="10" height="10" rx="2" fill="#f59e0b"/>
        <text x="196" y="9" font-family="Times New Roman" font-size="9" fill="#444">Leave</text>
      </g>
    </svg>
...
<div class="page">
  <h1 class="chapter-title">CHAPTER 5: CLOUD DEPLOYMENT &amp; DOCKERIZATION</h1>
...
<div class="page">
  <h1 class="chapter-title">CHAPTER 6: VERIFICATION &amp; RESULTS</h1>
...
<div class="page">
  <h1 class="chapter-title">CHAPTER 7: CONCLUSION &amp; FUTURE SCOPE</h1>

  <h2 class="section-title">7.1 Conclusion</h2>

  <p>The <strong>Trainee &amp; Internship Management Portal (TIMP)</strong> successfully modernizes and digitizes the trainee onboarding, scientist allocation, attendance tracking, and certificate issuance operations at the <strong>Solid State Physics Laboratory (SSPL - DRDO)</strong>.</p>
